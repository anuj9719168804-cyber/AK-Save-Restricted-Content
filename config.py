...
ADMINS = int(os.environ.get("ADMINS", "7521421400"))
...
CHANNEL_ID = os.environ.get("CHANNEL_ID", "-1003791757895")

# Your Mongodb Database Url
# Warning - Give Db uri in deploy server environment variable, don't give in repo.
DB_URI = os.environ.get("DB_URI", "mongodb+srv://Anujofficial:<db_password>@anuj.ml4aqxn.mongodb.net/?appName=Anuj") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
DB_NAME = os.environ.get("DB_NAME", "anujofficial9719")
